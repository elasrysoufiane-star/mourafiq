...
| `AUTO_DESCRIBE_INTERVAL` | `0` (à la demande) | 0 = pas de narration auto, l'assistant répond seulement sur commande (mode démo, contrôle total, pas d'écho). > 0 (ex. 10) = description continue « yeux permanents » toutes les N s (Claude + OCR) |
