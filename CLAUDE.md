...
| `AUTO_DESCRIBE_INTERVAL` | `4` (yeux permanents) | Description continue toutes les N s dès la fin de la parole précédente (scène + OCR, Claude). Défaut 4 depuis 2026-07-11 : la démo ne dépend pas de la voix (STT peu fiable sur le matériel actuel). 0 = à la demande uniquement |
