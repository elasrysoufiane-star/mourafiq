...
| `AUTO_DESCRIBE_INTERVAL` | `15` (yeux permanents) | Description continue N s après la fin de la parole précédente (scène + OCR, Claude) — 15s laisse de vraies fenêtres d'écoute micro entre deux narrations. 0 = à la demande uniquement |
