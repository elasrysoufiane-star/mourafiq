...
| `AUTO_DESCRIBE_INTERVAL` | `2` (narration quasi continue) | Description continue N s après la fin de la parole précédente (scène + OCR, Claude) — silence effectif ≈5-7s entre narrations. 0 = à la demande uniquement |
