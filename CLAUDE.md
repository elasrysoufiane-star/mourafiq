...
| `AUTO_DESCRIBE_INTERVAL` | `8` (yeux permanents) | Description continue N s après la fin de la parole précédente (scène + OCR, Claude) — narration ~toutes les 18-20s, la voix de l'utilisateur reste prioritaire (`user_speaking`). 0 = à la demande uniquement |
